...
<head>
    <meta charset="utf-8"/>
    <title>PVR Tech Admin | Forgot Password</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport"/>
    <meta content="" name="description"/>
    <meta content="" name="author"/>
    <!-- Favicon -->
    <link rel="icon" href="http://via.placeholder.com/32x32" sizes="32x32" type="image/png">
    ...
    <div class="content content--intro">
        <div class="frame">
            <header class="pvr__header">
                <h1 class="pvr__header__title">PVR Tech Studio</h1>
            </header>
        </div>
        <div class="content__inner">
            <h1 class="content__title">PVR Tech Studio</h1>
            <h3 class="content__subtitle">We Design Your Future</h3>
                            ...
                            <div class="col-lg-12">
                                <div class="header">
                                    <div class="logo m-t-15">
                                        <img class="w-in-22" src="http://via.placeholder.com/32x32" alt="PVR">
                                    </div>
