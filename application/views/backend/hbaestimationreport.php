        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-pvr">
                <div class="panel-heading">
                    <h4 class="panel-title">HBA1c Estimation Report</h4>
                </div>
                <div class="panel-body">
                    
                    <form action="<?php echo base_url();?>index.php/reports/generateHbaReport" method="POST" autocomplete="off">
                        <div class="row">
                            ...
                            <div class="form-group col-md-3" style="margin-top: 25px;">
                                <button type="button" id="showhbaChart" class="btn btn-sm btn-success pull-left m-r-5">Show</button>
                                <button type="submit" class="btn btn-sm btn-success pull-left m-r-5">Report</button>
                                <a href="<?php echo base_url();?>index.php/reports/hbareportform" class="btn btn-sm btn-warning pull-left m-r-5" title="Cancel">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
