            ...
            <!-- begin panel -->
                <div class="panel panel-pvr">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">User Activity List</h4>
                    </div>
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="activityTbl table table-striped table-bordered data_table width-full">
                        ...
                        <tr>
                            ...
                            <!-- <td>
                            <a href="<?php //echo base_url();?>useractivity/editUseractivity/<?php echo $value['id'];?>" title="Edit"><i class="material-icons">edit</i></a>
