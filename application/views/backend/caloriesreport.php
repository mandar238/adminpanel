...
<div id="content" class="content">
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-pvr">
                ...
                <div class="panel-body">
                    ...
                    <form action="<?php echo base_url();?>index.php/reports/getcaloriesReport" method="POST" autocomplete="off">
                        <div class="row">
                            ...
                            <div class="form-group col-md-3" style="margin-top: 25px;">
                                <button type="button" id="showcalChart" class="btn btn-sm btn-success pull-left m-r-5">Show</button>
                                <button type="submit" class="btn btn-sm btn-success pull-left m-r-5">Report</button>
                                <a href="<?php echo base_url();?>index.php/reports/caloriesreportform" class="btn btn-sm btn-warning pull-left m-r-5" title="Cancel">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="row" id="caloriesChart">
         <!-- begin col-12 -->
            <div class="col-md-12">
                <!-- begin panel -->
                <div class="panel panel-pvr">
                    <div class="panel-body">
                        <div class="p-0 high_chart" id="calories_chart">
                        </div>
                    </div>
                </div>
                <!-- end panel -->
